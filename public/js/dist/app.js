...
},{"./lib/babel/polyfill":1}],73:[function(require,module,exports){
module.exports = require("babel-core/polyfill");

},{"babel-core/polyfill":72}],74:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./jsx/Builder.jsx":75,"babel/polyfill":73}],75:[function(require,module,exports){
(function (global){
'use strict';
...
module.exports = React.createClass({
	...
	mixins: [require('./lib/builder-sliceInputs.js')],
...
function getInitialState() {
	var initialState = _.defaults({ slices: [4, 5, 6] }, defaults);
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'label',
								{ htmlFor: 'size', className: 'control-label col-sm-4' },
								'Size'
							),
							React.createElement(
								'div',
						...
						React.createElement(
							...
							React.createElement(
								'label',
								{ htmlFor: 'bgColor', className: 'control-label col-sm-4' },
								'BG Color'
							),
							React.createElement(
								'div',
						...
						React.createElement(
							...
							React.createElement(
								'label',
								{ htmlFor: 'stroke', className: 'control-label col-sm-4' },
								'Border Color'
							),
							React.createElement(
								'div',
						...
						React.createElement(
							...
							React.createElement(
								'label',
								{ htmlFor: 'strokeWidth', className: 'control-label col-sm-4' },
								'Border Size'
							),
							React.createElement(
								'div',
						...
						React.createElement(
							...
							React.createElement(
								'label',
								{ htmlFor: 'fills', className: 'control-label col-sm-4' },
								'Slice Colors'
							),
							React.createElement(
								'div',
...
},{"./Example.jsx":76,"./SliceInputs.jsx":77,"./lib/builder-sliceInputs.js":78}],76:[function(require,module,exports){
"use strict";
...
function render() {
	...
	return React.createElement(
		...
		React.createElement(
			"div",
			{ id: "exampleUrl", className: "panel-heading" },
			React.createElement(
				"a",
				{ href: src },
				"http://piely.net",
		...
		React.createElement(
			"div",
			{ id: "examplePie", className: "panel-body" },
...
function render() {
	...
	return React.createElement(
		"div",
		{ id: "slice-inputs" },
		_.map(slices, function (sliceValue, ixSlice) {
			return React.createElement(
				"div",
				{ className: "form-group", key: ixSlice },
				React.createElement(
					"div",
					{ className: "input-group" },
					React.createElement("input", {
		...
		React.createElement(
			...
			React.createElement(
				"div",
				{ className: "button btn btn-success btn-block", onClick: sliceControls.append },
				React.createElement(
					"div",
...
function componentDidUpdate(prevProps, prevState) {
	...
	if (prevState.slices.length < state.slices.length) {
		$('.slice:last').closest('.form-group').hide().slideDown().end().trigger('focus').trigger('select');
	}
}
